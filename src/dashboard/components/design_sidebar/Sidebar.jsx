...
import { Home, Users, BookOpen, Calendar, NotebookPen, CarFront, UserCircle } from 'lucide-react';
...
const Sidebar = () => {
  ...
  return (
    <div className="flex w-full">
      <aside className="min-w-64 bg-white shadow-sm flex flex-col h-screen sticky top-0">
        ...
        <nav className="flex-1 px-4 space-y-1 overflow-y-auto">
          ...
          <NavItem to="/dashboard/logo" icon={<Calendar size={20} />} label="Logo" location={location} />
