...
function Reset_password() {
  return (
    <div className="flex justify-center items-center h-screen ">
      <div className="w-150 bg-white shadow-xl shadow-gray-300 h-150 flex flex-col rounded-md ">
        <div className="py-5 px-10">
          ...
          <div className="flex justify-center  w-full mt-5 ">
            <button className="flex justify-center items-center gap-2 bg-blue-700 text-white rounded-md py-2 px-7 text-sm font-bold">
        ...
        <div className="flex flex-col items-center mt-2 bg-gray-50 ">
            <p className="text-xs p-2">
