...
function Login() {
    ...
    const handlelogin = async(e)=>{
        ...
        try{
            const res = await fetch("https://school-management-11-main-oxrub0.laravel.cloud/api/login",{
                method: "POST",
                headers:{
            ...
            <div className="bg-white w-full max-w-sm sm:max-w-md p-6 sm:p-8 rounded-2xl shadow-xl ">
                ...
                <form className="space-y-3" onSubmit={handlelogin}>
                    ...
                    <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 text-sm font-medium text-gray-500 hover:text-blue-600 transition-colors"
                    >
